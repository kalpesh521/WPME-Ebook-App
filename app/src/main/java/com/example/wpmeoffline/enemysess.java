...
public class enemysess extends AppCompatActivity {
    CardView partone;
    CardView parttwo;
    CardView partthree;
    CardView partfour;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_enemysess);
        ...
        partone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity( new Intent(    enemysess.this,PersonalityPDF.class));
            }
        });
