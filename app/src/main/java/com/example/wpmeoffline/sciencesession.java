...
public class sciencesession extends AppCompatActivity {
    CardView partone;
    CardView parttwo;
    CardView partthree;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sciencesession);
        ...
        partone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity( new Intent(sciencesession.this,PersonalityPDF.class));
            }
        });
