...
public class doctorsession extends AppCompatActivity {
    CardView partone;
    CardView parttwo;
    CardView partthree;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doctorsession);
        ...
        partone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity( new Intent(doctorsession.this,PersonalityPDF.class));
            }
        });
