...
public class practitionersession extends AppCompatActivity {
    CardView partone;
    CardView parttwo;
    CardView partthree;
    CardView partfour;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_practitionersession);
        ...
        partone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity( new Intent(practitionersession.this,PersonalityPDF.class));
            }
        });
