...
public class whatsesss extends AppCompatActivity {
    CardView partone;
    CardView parttwo;
    CardView partthree;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_whatsesss);
        ...
        partone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity( new Intent(   whatsesss.this,PersonalityPDF.class));
            }
        });
